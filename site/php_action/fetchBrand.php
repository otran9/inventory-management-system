...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group" style="white-space: nowrap">
		<button class="btn-default btn-custom" type="button" data-toggle="modal" id="editBrandsModalBtn" data-target="#editBrandModal" onclick="editBrands('.$brandId.')"><i class="glyphicon glyphicon-edit"></i> Edit</button>
		
		<button class="btn-danger btn-custom" type="button" data-toggle="modal" data-target="#removeMemberModal" id="removeBrandsModalBtn" onclick="removeBrands('.$brandId.')"><i class="glyphicon glyphicon-trash"></i> Remove</button>
	</div>';
