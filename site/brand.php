		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:5px;">
					<button class="btn-success btn-custom" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Brand </button>
				</div> <!-- /div-action -->				
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/createBrand.php" method="POST">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn-custom btn-default" data-dismiss="modal">Close</button>
	        
	        <button type="submit" class="btn-custom btn-success" id="createBrandBtn" data-loading-text="Loading..." autocomplete="off">Add Brand</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
			...
			<div class="modal-footer editBrandFooter">
				...
				<button type="submit" class="btn-custom btn-success" id="editBrandBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
			</div> <!-- /modal-footer -->
     	</form> <!-- /.form -->
    </div>
    <!-- /modal-content -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer removeBrandFooter">
        <button type="button" class="btn-custom btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
        <button type="button" class="btn-custom btn-danger" id="removeBrandBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Remove</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
